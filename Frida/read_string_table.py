#!/usr/bin/env python3
"""Read string table from horse's component pointer chain and display in CE format."""
import struct, sys

PID = 25355
MC_ADDR = 0x7CCB0210F540  # horse movement component
...
print(f'; Chain: MC({MC_ADDR:012X}) +0xA0 -> L1({l1:012X}) +0x40 -> L2({l2:012X}) +0x10 -> ST')
print()
